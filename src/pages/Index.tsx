  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        {/* Hero Section */}
        <section className="bg-gradient-to-br from-lms-blue-500 to-lms-teal-500 text-white">
        ...
        <section className="py-16 bg-background">
          <div className="container px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <Card className="border-t-4 border-t-lms-blue-500">
                <CardContent className="pt-6 text-center">
                  <div className="mb-4 w-12 h-12 bg-lms-blue-100 rounded-full flex items-center justify-center mx-auto">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-lms-blue-500">
              ...
              <Card className="border-t-4 border-t-lms-teal-500">
                <CardContent className="pt-6 text-center">
                  <div className="mb-4 w-12 h-12 bg-lms-teal-100 rounded-full flex items-center justify-center mx-auto">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-lms-teal-500">
        ...
        {/* CTA Section */}
        <section className="py-20 bg-gradient-to-r from-lms-blue-500 to-lms-teal-500 text-white">
          <div className="container px-4">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <Button size="lg" variant="secondary" className="bg-white text-lms-blue-700" asChild>
