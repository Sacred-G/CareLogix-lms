    ...
    <footer className="w-full border-t bg-[#181820]">
      <div className="container py-10">
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4">
          <div>
            <h3 className="text-lg font-semibold mb-4 heading-pink">{orgName}</h3>
            <p className="text-sm text-slate-300">
              Empowering support professionals with accessible, engaging training.
            </p>
          </div>
        ...
        <div className="mt-10 border-t pt-6 flex flex-col sm:flex-row items-center justify-between">
          <p className="text-sm text-muted-foreground">
            &copy; {new Date().getFullYear()} JFC TECHNOLOGIES. All rights reserved.
          </p>
