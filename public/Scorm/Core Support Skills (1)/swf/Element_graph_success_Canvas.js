...
(lib.bv_lights = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({regX:18.1,scaleX:0.49,scaleY:0.49},10).to({regX:18,scaleX:1,scaleY:1,rotation:18.3},15).to({rotation:-12.8},14).to({scaleX:1,scaleY:1,rotation:0},17).wait(27));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({startPosition:0},14).to({regX:-20.1,scaleX:1,scaleY:1,rotation:10.8,x:-5.4},15).to({regX:-20,scaleX:0.56,scaleY:0.56,rotation:-14.8,y:143.5},14).to({scaleX:1,scaleY:1,rotation:0,x:-5.3,y:143.4},17).wait(23));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).to({regX:-52.1,regY:131.1,scaleX:0.53,scaleY:0.53,x:54.6,y:175.6},13).to({regX:-52,regY:130.9,scaleX:1,scaleY:1,rotation:3.8,y:175.5},15).to({regY:131,scaleX:1,scaleY:1,rotation:-7.1},14).to({rotation:0,x:54.7},17).wait(24));
...
// stage content:
(lib.Element_graph_success_Canvas = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer 1
	this.instance = new lib.bv_success();
	this.instance.parent = this;
	this.instance.setTransform(204.2,216.2);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(286,456.2,11.5,16.2);
// library properties:
lib.properties = {
	id: 'B585511D8D31314FB9B5C11015429D37',
	width: 400,
	height: 400,
	fps: 24,
	color: "#CCCCCC",
...
an.compositions['B585511D8D31314FB9B5C11015429D37'] = {
